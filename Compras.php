...
">
  ...
  <body>
	<?php 
		$result = mysqli_query($connect,"SELECT * FROM mercadoria where tipnegoc_merc='Compra'");
		$row=mysqli_fetch_assoc($result);
		$codigo=$row["cod_merc"];
    // output data of each row tipnegoc_merc,nome_merc,tipmerc_merc,preco_merc,qtd_merc 
